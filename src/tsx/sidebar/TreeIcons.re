...
let iconStyle = ReactDOMRe.Style.make(~width="14px", ~height="14px", ());

module MinusSquare = {
  [@react.component]
  let make = () => {
    <SvgIcon fontSize=`Inherit style=iconStyle>
      <path
...
module CloseSquare = {
  [@react.component]
  let make = () => {
    <SvgIcon fontSize=`Inherit style=iconStyle className="close">
      <path
